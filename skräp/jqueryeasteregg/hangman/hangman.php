...
<html lang="en">
  ...
  <body class="navbar-inverse">
    ...
    <blockquote>
      <p class="text-center slogan">Prove that you are an opposer of capital punishment</p>
    </blockquote>
    <div class="container-fluid">
      ...
      <div class="col-sm-4">
        <h4 class="text-center"><i><u>Instructions:</u></i></h4>
        <p class="description">
          Your objective is to free the hanging man! In this game of nodes you must guess each letter of the chosen "safe word" before running out of chances. If you can not find the word, the man will appear hung. There are 100 different possible words for this game, meaning each game has a high chance of a new word. The words will not contain numbers, special characters, or symbols. All words used can be found in the American English dictionary. You have 10 guesses to find the safe word. Please make sure caps lock is off.</br><span>Type the letters below to play the game. (Clicking is forbidden)</span>
        </p>
